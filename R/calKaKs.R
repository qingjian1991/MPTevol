#' calKaKs
#'
#' calculate the Ka/Ks of each group. The mutation are classified as **classifyMut**
#'
...
#' @param class: The class which would be represented. "SP" (Shared pattern: Public/Shared/Private), other options: "CS" (Clonal status: Clonal/Subclonl) and "SPCS". see MesKit **classifyMut**.

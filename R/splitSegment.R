...
#' splitSegment
#'
#' split the segment regions into several parts, according to their shared status.
#'
...
splitSegment =  function(segfiles, sampleid, out.dir = "data",  tumor = "tumor",
                     N.baf = 30, cnv_min_length = 1e5, max_CNt = 10 ,
